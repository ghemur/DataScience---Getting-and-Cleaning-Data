...
write.table(means_by_part_subject_activity, outFile, col.names = TRUE)
...
write.table(means_by_subject_activity, outFile, col.names = TRUE)
...
write.table(all_means, outFile, col.names = TRUE)
